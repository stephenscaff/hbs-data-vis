...
gulp.task('data', () => {
  ...
  return gulp.src(folder.src + 'assets/data/*')
    .pipe(include())
 ...
 * Runner
 */
gulp.task('run', ['images', 'hbs', 'scss', 'jquery', 'js', 'data', 'templates', 'jshint', 'serve']);
...
gulp.task('watch', () => {
  ...
  gulp.watch(folder.src + 'assets/data/*', ['data']);
  gulp.watch(folder.src + 'assets/templates/*', ['templates']);
